...
!!! warning ""
    Please do not be overwhelmed, most of your `figgy.json` can be autogenerated. Check out our [shared libraries](/user-guides/how-to/manage-application-configs/)!
